...
import xanketes.gestionbibliotecaspringboot.presentador.VistaPrestamos;
import xanketes.gestionbibliotecaspringboot.vista.componentes.MiModeloDatosSoloLectura;
...
public class ListaPrestamos extends JInternalFrame implements VistaPrestamos, MouseListener, FocusListener, KeyListener, ActionListener {
    ...
    private void muestraFicha(Prestamo prestamo) {
        try {
            FormMain.getInstance().getDesktopPane().add(xanketes.gestionbibliotecaspringboot.vista.helper.Prestamos.fichaPrestamo(prestamo));
        } catch (Exception e) {
